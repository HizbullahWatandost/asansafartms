...
<head>
  ...
  <title>Asan Safar  | Operator Activiy Loggings</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <section class="content" style="padding-top: 1em;">
            <h4>Operators Activity Loggings </h4>
            <hr />
                  ...
                  <div class="card">
                    <div class="card-body">
                      <table id="example" class="table table-bordered table-striped">
                        ...
                        <tbody>
                          <?php $no=1;
                            $getAdminLog = $database->query("SELECT * FROM logging WHERE userType = 'Operator' OR userType = 'operator'");
