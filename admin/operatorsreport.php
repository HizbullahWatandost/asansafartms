...
<head>
  ...
  <title>Asan Safar  | Operator Reports</title>
                      ...
                      <table id="example" class="table table-bordered table-striped">
                        ...
                        <tbody>
                          <?php $no=1;
                            ...
                            while($operator = $database->fetch_array($getAllUsers)) { ?>
                              <tr>
                                <td><?php echo $no++; ?></td>
                                <td><?php echo $operator['adminFullName']; ?></td>
                                <td><?php echo $operator['adminEmail']; ?></td>
                                <td><?php echo $operator['adminMobile']; ?></td>
                                <td><?php if($operator['admintStatus'] === '1') {
                                              echo 'Unlocked';
                                            }else {
                                              echo 'Locked';
                                            } ?>
