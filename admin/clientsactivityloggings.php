...
<head>
  ...
  <title>Asan Safar  | Clients Activiy Loggins</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <section class="content" style="padding-top: 1em;">
            <h4>Clients Activity Loggings </h4>
            <hr />
                  ...
                  <div class="card">
                    <div class="card-body">
                      <table id="example" class="table table-bordered table-striped">
                        ...
                        <tbody>
                          <?php $no=1;
                          $getClientsLog = $database->query("SELECT * FROM logging WHERE userType = 'Client' OR userType = 'client'");
