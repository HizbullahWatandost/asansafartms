<?php
  ...
  include ('inc/operator_register.php');
 ?>
<!DOCTYPE html>
<html>
<head>
  ...
  <title>Asan Safar  | Register a new operator</title>
              ...
              <div class="card-body">
               ...
               <div class="card card-primary card-outline offset-sm-2 col-sm-8">
                 <div class="card-body box-profile">
                   ...
                   <p class="text-muted text-center">Asan Safar Operator</p>
                   ...
                   <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                     ...
                     <div class="text-center">
                       ...
                       <div class="offset-sm-4 col-sm-4">
                         <button type="submit" name="operatorRegister" class="btn btn-primary btn-block">Register</button>
                       </div>
                       <!-- /.col -->
                     </div>
                   </form>
